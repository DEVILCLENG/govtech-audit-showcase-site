              ...
              {auditors.map((auditor, index) => <Card key={index} className="overflow-hidden">
                  <CardContent className="p-6">
                    ...
                    <div className="flex flex-wrap gap-2 mb-4">
                      {auditor.certifications.map((cert, idx) => <span key={idx} className="bg-primary/10 text-primary text-xs md:text-sm lg:text-base py-1 px-2 rounded-md">
                          {cert}
                        </span>)}
                    </div>
